    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center px-6">
        <div className="w-full max-w-md text-center">
          ...
          <h1 className="text-3xl text-white mb-3 tracking-widest font-heading">ACCOUNT CREATED</h1>
    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400 text-sm">Join us to explore exclusive timepieces and jewellery</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label className="text-gray-400 text-xs tracking-widest uppercase">First Name</Label>
              <Input
                type="text"
                value={firstName}
            ...
            <div className="space-y-2">
              <Label className="text-gray-400 text-xs tracking-widest uppercase">Last Name</Label>
              <Input
                type="text"
                value={lastName}
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-500 text-sm">
            ...
            <Link
              href={redirect ? `/login?redirect=${encodeURIComponent(redirect)}` : "/login"}
              className="text-white hover:underline transition-colors tracking-wider"
            >
              Sign In
            </Link>
          </p>
